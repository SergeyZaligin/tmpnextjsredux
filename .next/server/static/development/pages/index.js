...
var _jsxFileName = "C:\\Users\\user\\Desktop\\ReactJS\\proj\\nexttmp\\components\\clock.js";
...
/* harmony import */ var _store_actions_example__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../store/actions/example */ "./store/actions/example.js");
var _jsxFileName = "C:\\Users\\user\\Desktop\\ReactJS\\proj\\nexttmp\\components\\counter.js";
...
function (_Component) {
  ...
  function Counter() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "increment", function () {
      ...
      dispatch(Object(_store_actions_example__WEBPACK_IMPORTED_MODULE_2__["incrementCount"])());
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "decrement", function () {
      var dispatch = _this.props.dispatch;
      dispatch(Object(_store_actions_example__WEBPACK_IMPORTED_MODULE_2__["decrementCount"])());
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "reset", function () {
      var dispatch = _this.props.dispatch;
      dispatch(Object(_store_actions_example__WEBPACK_IMPORTED_MODULE_2__["resetCount"])());
    });
...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      ...
      this.timer = Object(_store_actions_example__WEBPACK_IMPORTED_MODULE_2__["startClock"])(dispatch);
    }
  }, {
    ...
    value: function getInitialProps(_ref) {
      var reduxStore = _ref.reduxStore,
          req = _ref.req;
      var isServer = !!req;
      reduxStore.dispatch(Object(_store_actions_example__WEBPACK_IMPORTED_MODULE_2__["serverRenderClock"])(isServer));
      return {};
    }
  }]);
...
var serverRenderClock = function serverRenderClock(isServer) {
  return function (dispatch) {
    return dispatch({
      type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__["actionTypes"].TICK,
      light: !isServer,
      ts: Date.now()
    });
  };
...
var incrementCount = function incrementCount() {
  return function (dispatch) {
    return dispatch({
      type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__["actionTypes"].INCREMENT
    });
  };
};
var decrementCount = function decrementCount() {
  return function (dispatch) {
    return dispatch({
      type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__["actionTypes"].DECREMENT
    });
  };
};
var resetCount = function resetCount() {
  return function (dispatch) {
    return dispatch({
      type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__["actionTypes"].RESET
    });
  };
};
